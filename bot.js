...
『f!info / لمعرفه من صنع البوت وللتواصل معه』
**
...
const Za7f = [  
    "** وش اسم امك  :JOY:**.",
    "**مين اكثر شخص تحبه من البنات :JOY: **.",
...
client.on("message", async message => {
    if(message.content.startsWith(prefix + "info")) {
        let help = new Discord.RichEmbed()
            ...
            .setThumbnail(message.author.avatarURL)
            .setDescription(`** 
            فكره البوت مثل برو بوت الخ .
            البوت مميز في انه يوجد العاب قصيره واوامر اداريه 
            وكل فتره سيتم اضافه اشياء اكثر 
            ✧▬▬▬▬▬▬▬▬▬✦ஜ۩۞۩ஜ✧▬▬▬▬▬▬▬▬▬▬▬✦
            تم صنع البوت عمر | ReTir'ed - Marshmallo
            وللتواصل معه خاص ديسكورد | ! Marshmallo { SN1 } 😢💔#1000
            **`);
 ...
 **
رابط السيرفر | https://discord.gg/HQrSRG
 **
`);
  message.author.sendEmbed(embed);
   }
